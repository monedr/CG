...
int main(void)
{
	...
	do{
		...
		ViewMatrix = glm::lookAt(
			glm::vec3(0.f, 0.f, 5.0f), //origem
			glm::vec3(0.f, 0.f, 0.f), //look
			glm::vec3(0.0f, 1.0f, 0.0f) //up
		);
		ViewMatrix = glm::translate(ViewMatrix, glm::catmullRom(vec3(0.0f, 0.0f, 0.0f), vec3(2.0f, 5.0f, 0.0f), vec3(3.0f, 5.0f, 0.0f), vec3(5.0f, 0.0f, 0.0f), ((currentTime - lastAniTime) > 5)));
